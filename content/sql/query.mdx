...
<Accordion title="&lt;cte definition&gt;">
...
<Accordion title="&lt;select statement&gt;">
...
<Accordion title="TRACK_ID_COLUMN">
...
<Accordion title="SEARCH_ID_COLUMN">
...
<Accordion title="SPATIAL_SOLUTION_TYPE">
...
<Accordion title="SEARCH_TIME_DISTANCE">
...
<Accordion title="GEOFENCE_TABLE">
...
<Accordion title="GEOFENCE_ID_COLUMN">

Geofence column, containing the unique identifier for the geofence.

</Accordion>

<Accordion title="GEOFENCE_WKT_COLUMN">
...
<table class="table w-full [&_td]:min-w-[150px] [&_th]:text-left [&_td[data-numeric]]:tabular-nums">
  ...
  <tr>
    ...
    <td>If *true*, the filter will be case-sensitive; if false, case-insensitive. .. note::  Not applicable when <code>MODE</code> is <code>search</code>.</td>
  </tr>
  </tbody>
</table>
</div>
...
<Accordion title="PREDICT_ON_TABLE">
...
<Accordion title="PREDICT_ON_COLUMN">
...
<Accordion title="PREDICT_METHOD">
...
<Accordion title="OUTLIER_METHOD">
...
<Accordion title="THRESHOLD_HIGH">
...
<Accordion title="&lt;remote query&gt;">

SQL query to execute on the remote system.

</Accordion>

<Accordion title="&lt;data source name&gt;">
