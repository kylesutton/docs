...
<Accordion title="FIRST_VALUE(&lt;column&gt;) [&lt;IGNORE | RESPECT&gt; NULLS]">
...
<Accordion title="LAG(&lt;column&gt;[, &lt;num&gt;]) [&lt;IGNORE | RESPECT&gt; NULLS]">
...
<Accordion title="LAST_VALUE(&lt;column&gt;) [&lt;IGNORE | RESPECT&gt; NULLS]">
...
<Accordion title="LEAD(&lt;column&gt;[, &lt;num&gt;]) [&lt;IGNORE | RESPECT&gt; NULLS]">
...
<Accordion title="NTILE(&lt;num of groups&gt;)">
...
<Accordion title="ARRAY_AGG(expr)">
...
<Accordion title="ARRAY_AGG_DISTINCT(expr)">
...
<Accordion title="UNNEST_JSON_ARRAY">
...
<Accordion title="DECODE(expr, match_a, value_a, ..., match_N, value_N[, unmatched_value])">
...
<Accordion title="IF(expr, value_if_true, value_if_false)">
...
<Accordion title="CAST (expr AS [SQL_]&lt;conv_type&gt;) *or* CONVERT (expr, [SQL_]&lt;conv_type&gt;)">
...
<Accordion title="TO_DATE(string, format)">
...
<Accordion title="TO_DATETIME(string, format)">
...
<Accordion title="TO_TIME(string, format)">
...
<Accordion title="TO_TIMESTAMP(string, format)">
...
<Accordion title="ULONG(expr)">

Converts the given `expr` to `UNSIGNED BIGINT` type

</Accordion>

<Accordion title="VECTOR(expr, len)">
...
<Accordion title="CLOCK_TIMESTAMP()">
...
<Accordion title="CURRENT_DATETIME()">
...
<Accordion title="CURRENT_TIME()">

Returns the time as `HH24:MI:SS.mmm`

</Accordion>

<Accordion title="CURRENT_TIMESTAMP()">
...
<Accordion title="DATEADD (unit, amount, expr)">
...
<Accordion title="DATE_BUCKET (width, ds[, offset[, base]])">
...
<Accordion title="DATEDIFF ([unit,] begin, end)">
...
<Accordion title="DATEPART(part, expr)">
...
<Accordion title="DATE_TRUNC(part, expr)">
...
<Accordion title="DAY(expr)">

Alias for `DAYOFMONTH(expr)`

</Accordion>

<Accordion title="DAYNAME(expr)">
...
<Accordion title="DAYOFMONTH(expr)">

Extracts the day of the month from `expr` [`1` - `31`]

</Accordion>

<Accordion title="DAYOFWEEK(expr)">
...
<Accordion title="DAY_OF_WEEK(expr)">

Alias for `DAYOFWEEK(expr)`

</Accordion>

<Accordion title="DAYOFYEAR(expr)">

Extracts the day of the year from `expr` [`1` - `366`]

</Accordion>

<Accordion title="DAY_OF_YEAR(expr)">

Alias for `DAYOFYEAR(expr)`

</Accordion>

<Accordion title="EPOCH_MSECS_TO_DATETIME(expr)">
...
<Accordion title="EPOCH_SECS_TO_DATETIME(expr)">
...
<Accordion title="EXTRACT(&lt;part&gt; FROM &lt;expr&gt;)">
...
<Accordion title="HOUR(expr)">

Extracts the hour of the day from `expr` [`0` - `23`]

</Accordion>

<Accordion title="&lt;expr&gt; + INTERVAL '&lt;amount&gt;' &lt;part&gt; &lt;expr&gt; - INTERVAL '&lt;amount&gt;' &lt;part&gt;">
...
<Accordion title="MSEC(expr)">

Extracts the millisecond of the second from `expr` [`0` - `999`]

</Accordion>

<Accordion title="MSECS_SINCE_EPOCH(expr)">
...
<Accordion title="NEXT_DAY(date, day_of_week)">
...
<Accordion title="SECOND(expr)">

Extracts the seconds of the minute from `expr` [`0` - `59`]

</Accordion>

<Accordion title="SEC(expr)">

Alias for `SECOND(expr)`

</Accordion>

<Accordion title="SECS_SINCE_EPOCH(expr)">
...
<Accordion title="TIME_BUCKET (width, ts[, offset[, base]])">
...
<Accordion title="TIMESTAMPADD (unit, amount, expr)">
...
<Accordion title="TIMESTAMPDIFF (unit, begin, end)">
...
<Accordion title="TIMESTAMP_TRUNC(part, expr)">

Alias for `DATE_TRUNC(part, expr)`

</Accordion>

<Accordion title="UNIX_TIMESTAMP(expr)">

Alias for `SECS_SINCE_EPOCH(expr)`

</Accordion>

<Accordion title="WEEK(expr)">
...
<Accordion title="DATE_TO_EPOCH_MSECS(year, month, day, hour, min, sec, msec)">
...
<Accordion title="DATE_TO_EPOCH_SECS(year, month, day, hour, min, sec)">
...
<Accordion title="TIMESTAMP_FROM_DATE_TIME(date, time)">
...
<Accordion title="WEEK_TO_EPOCH_MSECS(year, week_number)">
...
<Accordion title="WEEK_TO_EPOCH_SECS(year, week_number)">
...
<Accordion title="STXY_CONTAINS(geom, x, y)">
...
<Accordion title="STXY_CONTAINSPROPERLY(geom, x, y)">
...
<Accordion title="STXY_COVEREDBY(x, y, geom)">

Returns `1` (true) if the `x` and `y` coordinate is covered by `geom`

</Accordion>

<Accordion title="STXY_COVERS(geom, x, y)">

Returns `1` (true) if `geom` covers the `x` and `y` coordinate

</Accordion>

<Accordion title="STXY_DISJOINT(x, y, geom)">
...
<Accordion title="STXY_DISTANCE (x, y, geom[, solution])">
...
<Accordion title="STXY_DWITHIN (x, y, geom, distance[, solution])">
...
<Accordion title="STXY_ENVDWITHIN (x, y, geom, distance[, solution])">
...
<Accordion title="STXY_ENVINTERSECTS(x, y, geom)">
...
<Accordion title="STXY_GEOHASH(x, y[, precision])">
...
<Accordion title="STXY_INTERSECTS(x, y, geom)">

Returns `1` (true) if the `x` and `y` coordinate and `geom` intersect in 2-D.

</Accordion>

<Accordion title="STXY_TOUCHES(x, y, geom)">
...
<Accordion title="STXY_WITHIN(x, y, geom)">
...
<Accordion title="GEOHASH_DECODE_LONGITUDE(geohash)">
...
<Accordion title="ST_ALMOSTEQUALS (geom1, geom2[, decimal])">
...
<Accordion title="ST_AREA(geom[, solution])">
...
<Accordion title="ST_AZIMUTH(geom1, geom2)">
...
<Accordion title="ST_BOUNDARY(geom)">
...
<Accordion title="ST_BOUNDINGDIAGONAL(geom)">

Returns the diagonal of the given geometry's (`geom`) bounding box.

</Accordion>

<Accordion title="ST_BUFFER (geom, radius[, style[, solution]])">
...
<Accordion title="ST_BUFFERBYCOMPONENT (geom, radius[, style[, solution]])">
...
<Accordion title="ST_CENTROID(geom)">
...
<Accordion title="ST_CLIP(geom1, geom2)">

Returns the geometry shared between given geometries `geom1` and `geom2`

</Accordion>

<Accordion title="ST_CLOSESTPOINT (geom1, geom2[, solution])">
...
<Accordion title="ST_COLLECT(geom1, geom2)">
...
<Accordion title="ST_COLLECTIONEXTRACT (collection, type)">
...
<Accordion title="ST_COLLECTIONHOMOGENIZE(collection)">
...
<Accordion title="ST_CONCAVEHULL (geom, target_percent[, allow_holes])">
...
<Accordion title="ST_CONTAINS(geom1, geom2)">
...
<Accordion title="ST_CONTAINSPROPERLY(geom1, geom2)">
...
<Accordion title="ST_COVEREDBY(geom1, geom2)">

Returns `1` (true) if no point in `geom1` is outside `geom2`.

</Accordion>

<Accordion title="ST_COVERS(geom1, geom2)">

Returns `1` (true) if no point in `geom2` is outside `geom1`.

</Accordion>

<Accordion title="ST_CROSSES(geom1, geom2)">
...
<Accordion title="ST_DISJOINT(geom1, geom2)">

Returns `1` (true) if the given geometries, `geom1` and `geom2`, do not spatially intersect.

</Accordion>

<Accordion title="ST_DISTANCE(geom1, geom2[, solution])">
...
<Accordion title="ST_DISTANCEPOINTS (x1, y1, x2, y2[, solution])">
...
<Accordion title="ST_DFULLYWITHIN (geom1, geom2, distance[, solution])">
...
<Accordion title="ST_DWITHIN (geom1, geom2, distance[, solution])">
...
<Accordion title="ST_ELLIPSE(x, y, height, width)">
...
<Accordion title="ST_ENDPOINT(geom)">
...
<Accordion title="ST_ENVDWITHIN (geom1, geom2, distance[, solution])">
...
<Accordion title="ST_EQUALSEXACT (geom1, geom2[, tolerance])">
...
<Accordion title="ST_EXPANDBYRATE(geom, rate)">
...
<Accordion title="ST_FORCE3D(geom[, z])">
...
<Accordion title="ST_GENERATEPOINTS(geom, num)">
...
<Accordion title="ST_GEOHASH(geom[, precision])">
...
<Accordion title="ST_GEOMETRYFROMTEXT(wkt)">

Alias for `ST_GEOMFROMTEXT(wkt)`

</Accordion>

<Accordion title="ST_GEOMETRYN(geom, index)">
...
<Accordion title="ST_GEOMETRYTYPE(geom)">

Returns the type of geometry from the given `geom`.

</Accordion>

<Accordion title="ST_GEOMETRYTYPEID(geom)">
...
<Accordion title="ST_GEOMFROMGEOHASH (geohash[, precision])">
...
<Accordion title="ST_INTERIORRINGN(geom, n)">
...
<Accordion title="ST_ISEMPTY(geom)">

Returns `1` (true) if `geom` is empty

</Accordion>

<Accordion title="ST_ISRING(geom)">
...
<Accordion title="ST_ISSIMPLE(geom)">
...
<Accordion title="ST_ISVALID(geom)">
...
<Accordion title="ST_ISVALIDREASON(geom)">
...
<Accordion title="ST_LENGTH(geom[, solution])">
...
<Accordion title="ST_LINEFROMMULTIPOINT(geom)">
...
<Accordion title="ST_LINEINTERPOLATEPOINT(geom, frac)">
...
<Accordion title="ST_LINELOCATEPOINT(linestring, point)">
...
<Accordion title="ST_LINEMERGE(geom)">
...
<Accordion title="ST_LINESUBSTRING (geom, start_frac, end_frac)">
...
<Accordion title="ST_LONGESTLINE (geom1, geom2[, solution])">
...
<Accordion title="ST_MAKEENVELOPE (xmin, ymin, xmax, ymax)">

Creates a rectangular POLYGON from the given min and max parameters

</Accordion>

<Accordion title="ST_MAKELINE(geom[, geom2])">
...
<Accordion title="ST_MAKEPOINT(x, y)">
...
<Accordion title="ST_MAKEPOLYGON(geom)">
...
<Accordion title="ST_MAKETRIANGLE2D (x1, y1, x2, y2, x3, y3)">

Creates a closed 2-D POLYGON with three vertices

</Accordion>

<Accordion title="ST_MAKETRIANGLE3D (x1, y1, z1, x2, y2, z2, x3, y3, z3)">

Creates a closed 3-D POLYGON with three vertices

</Accordion>

<Accordion title="ST_MAKEVALID(geom[, options])">
...
<Accordion title="ST_MAXDISTANCE (geom1, geom2[, solution])">
...
<Accordion title="ST_MULTI(geom)">

Returns `geom` as a MULTI- geometry, e.g., a POINT would return a MULTIPOINT.

</Accordion>

<Accordion title="ST_MULTIPLERINGBUFFERS (geom, distance[, outside])">
...
<Accordion title="ST_NEAR(geom1, geom2)">
...
<Accordion title="ST_NORMALIZE(geom)">
...
<Accordion title="ST_NPOINTS(geom)">

Returns the number of points (vertices) in `geom`.

</Accordion>

<Accordion title="ST_NRINGS(geom)">
...
<Accordion title="ST_NUMGEOMETRIES(geom)">
...
<Accordion title="ST_NUMINTERIORRINGS(geom)">
...
<Accordion title="ST_NUMPOINTS(geom)">
...
<Accordion title="ST_OVERLAPS(geom1, geom2)">
...
<Accordion title="ST_PARTITION(geom[, threshold])">
...
<Accordion title="ST_PERIMETER(geom[, solution])">
...
<Accordion title="ST_POINT(x, y)">

Returns a POINT with the given `x` and `y` coordinates.

</Accordion>

<Accordion title="ST_POINTFROMGEOHASH (geohash[, precision])">
...
<Accordion title="ST_POINTGRID (xmin, ymin, xmax, ymax, cell_side[, limit])">
...
<Accordion title="ST_POINTN(geom, n)">
...
<Accordion title="ST_POINTS(geom)">

Returns a MULTIPOINT containing all of the coordinates of `geom`.

</Accordion>

<Accordion title="ST_PROJECT(geom, distance, azimuth)">
...
<Accordion title="ST_REMOVEPOINT(geom, offset)">
...
<Accordion title="ST_REMOVEREPEATEDPOINTS (geom, tolerance)">
...
<Accordion title="ST_REVERSE(geom)">

Return the geometry with its coordinate order reversed.

</Accordion>

<Accordion title="ST_ROTATE(geom, radians[, wkt])">
...
<Accordion title="ST_ROTATE(geom, radians[, x, y])">
...
<Accordion title="ST_SCALE(geom, wkt)">
...
<Accordion title="ST_SCALE(geom, x, y)">
...
<Accordion title="ST_SEGMENTIZE (geom, max_segment_size[, solution])">
...
<Accordion title="ST_SETPOINT(geom1, position, geom2)">
...
<Accordion title="ST_SHAREDPATH(geom1, geom2)">

Returns a collection containing paths shared by `geom1` and `geom2`.

</Accordion>

<Accordion title="ST_SHORTESTLINE(geom1, geom2)">
...
<Accordion title="ST_SIMPLIFY(geom, tolerance)">
...
<Accordion title="ST_SIMPLIFYPRESERVETOPOLOGY (geom, tolerance)">
...
<Accordion title="ST_SNAP(geom1, geom2, tolerance)">
...
<Accordion title="ST_SPLIT(geom1, geom2)">
...
<Accordion title="ST_SQUAREGRID (xmin, ymin, xmax, ymax, cell_side[, limit])">
...
<Accordion title="ST_STARTPOINT(geom)">
...
<Accordion title="ST_SYMDIFFERENCE(geom1, geom2)">
...
<Accordion title="ST_TOUCHES(geom1, geom2)">
...
<Accordion title="ST_TRANSLATE (geom, deltax, deltay[, deltaz])">
...
<Accordion title="ST_TRIANGLEGRID (xmin, ymin, xmax, ymax, cell_side[, limit])">
...
<Accordion title="ST_UNION(geom1, geom2)">
...
<Accordion title="ST_WITHIN(geom1, geom2)">
...
<Accordion title="ST_XMAX(geom)">

Alias for `ST_MAXX()`

</Accordion>

<Accordion title="ST_XMIN(geom)">

Alias for `ST_MINX()`

</Accordion>

<Accordion title="ST_Y(geom)">
...
<Accordion title="ST_YMAX(geom)">

Alias for `ST_MAXY()`

</Accordion>

<Accordion title="ST_YMIN(geom)">

Alias for `ST_MINY()`

</Accordion>

<Accordion title="ST_ZMAX(geom)">

Alias for `ST_MAXZ()`

</Accordion>

<Accordion title="ST_ZMIN(geom)">
...
<Accordion title="ST_AGGREGATE_COLLECT(geom)">

Alias for `ST_COLLECT_AGGREGATE()`

</Accordion>

<Accordion title="ST_AGGREGATE_INTERSECTION(geom)">

Alias for `ST_INTERSECTION_AGGREGATE()`

</Accordion>

<Accordion title="ST_COLLECT_AGGREGATE(geom)">
...
<Accordion title="ST_DISSOLVE(geom)">
...
<Accordion title="ST_DISSOLVEOVERLAPPING(geom)">
...
<Accordion title="ST_INTERSECTION_AGGREGATE(geom)">
...
<Accordion title="ST_LINESTRINGFROMORDEREDPOINTS(x, y, t)">
...
<Accordion title="ST_LINESTRINGFROMORDEREDPOINTS3D(x, y, z, t)">
...
<Accordion title="ST_POLYGONIZE(geom)">
...
<Accordion title="ST_TRACKDURATION([unit,] t)">
...
<Accordion title="ST_TRACKLENGTH(lat, lon, t[, solution])">
...
<Accordion title="H3_CELLTOBOUNDARY(h3_index)">
...
<Accordion title="H3_CELLTOCENTERCHILD(h3_index, res)">

Alias for `H3_CELLTOFIRSTCHILD`.

</Accordion>

<Accordion title="H3_CELLTOCHILDN(h3_index, res, i)">
...
<Accordion title="H3_CELLTOCHILDPOS(h3_index, res)">
...
<Accordion title="H3_CELLTOCHILDRENSIZE(h3_index, res)">

Returns the number of child cells at resolution `res` for the given `h3_index`.

</Accordion>

<Accordion title="H3_CELLTOFIRSTCHILD(h3_index, res)">
...
<Accordion title="H3_CELLTOLASTCHILD(h3_index, res)">
...
<Accordion title="H3_GRIDRING(h3_index, k)">
...
<Accordion title="H3_H3TOSTRING(h3_index)">
...
<Accordion title="H3_ISVALID(h3_index)">
...
<Accordion title="H3_LATLNGTOCELL (latitude, longitude, res)">
...
<Accordion title="H3_NUMGRIDDISK(h3_index, k)">
...
<Accordion title="H3_NUMPOLYGONTOCELLS(geom, res)">
...
<Accordion title="H3_POLYGONTOCELLS(geom, res)">
...
<Accordion title="H3_POLYGONTOCELLSN(geom, res, i)">
...
<Accordion title="H3_STRINGTOH3(h3_string)">
...
<Accordion title="H3_XYTOCELL(x, y, res)">
...
<Accordion title="COALESCE(expr_a, ..., expr_N)">
...
<Accordion title="IFNULL(expr_a, expr_b)">
...
<Accordion title="ISNULL(expr)">

Alias for `IS_NULL(expr)`

</Accordion>

<Accordion title="NULLIF(expr_a, expr_b)">
...
<Accordion title="NVL(expr_a, expr_b)">

Alias for `IFNULL`

</Accordion>

<Accordion title="NVL2(expr, value_if_not_null, value_if_null)">
...
<Accordion title="REMOVE_NULLABLE(expr)">

Alias for `ZEROIFNULL`

</Accordion>

<Accordion title="ZEROIFNULL(expr)">
...
<Accordion title="KI_CHUNK_MAX(col)">
...
<Accordion title="KI_CHUNK_MIN(col)">
...
<Accordion title="KI_CHUNK_OFFSET()">

Returns the index of the record within the chunk.

</Accordion>

<Accordion title="KI_PARTITION()">
...
<Accordion title="ASCII(expr)">

Returns the ASCII code for the first byte in `expr`

</Accordion>

<Accordion title="BIN(expr[, minimum_digits])">
...
<Accordion title="CONCAT(expr_a, expr_b)">
...
<Accordion title="CONCAT_TRUNCATE(expr_a, expr_b)">
...
<Accordion title="CONTAINS(match, expr)">
...
<Accordion title="CONV(expr, from_base, to_base)">
...
<Accordion title="DEC2HEX(expr[, minimum_digits])">

Alias for `HEX`

</Accordion>

<Accordion title="DIFFERENCE(expr_a, expr_b)">
...
<Accordion title="EDIT_DISTANCE(expr_a, expr_b)">
...
<Accordion title="ENDS_WITH(match, expr)">
...
<Accordion title="FROM_HEX(expr)">

Alias for `UNHEX`

</Accordion>

<Accordion title="HEX(expr[, minimum_digits])">
...
<Accordion title="HEX2DEC(expr)">

Alias for `UNHEX`

</Accordion>

<Accordion title="INITCAP(expr)">

Returns `expr` with the first letter of each word in uppercase

</Accordion>

<Accordion title="IPV4_PART(expr, part_num)">
...
<Accordion title="IS_IPV4(expr)">

Returns `1` if `expr` is an IPV4 address; returns `0` otherwise

</Accordion>

<Accordion title="ISIPV4(expr)">

Alias for `IS_IPV4`

</Accordion>

<Accordion title="LCASE(expr)">

Converts `expr` to lowercase

</Accordion>

<Accordion title="LEFT(expr, num_bytes)">

Returns the leftmost `num_bytes` bytes from `expr`

</Accordion>

<Accordion title="LEN(expr)">

Alias for `LENGTH`

</Accordion>

<Accordion title="LENGTH(expr)">

Returns the number of characters in `expr`

</Accordion>

<Accordion title="LOCATE(match, expr[, start_pos])">
...
<Accordion title="LOWER(expr)">

Alias for `LCASE`

</Accordion>

<Accordion title="LPAD(expr, length, pad)">
...
<Accordion title="LTRIM(expr)">

Removes whitespace from the left side of `expr`

</Accordion>

<Accordion title="OCT(expr[, minimum_digits])">
...
<Accordion title="POSITION(match IN expr)">
...
<Accordion title="REGEXP_COUNT (expr, regex[, position [, mode]])">
...
<Accordion title="REGEXP_INSTR (expr, regex [, position [, occurrence [, begin_end [, mode [,group]]]]])">
...
<Accordion title="REGEXP_LIKE(expr, regex[, mode])">
...
<Accordion title="REGEXP_MATCH(expr, regex[, options])">

Alias for `REGEXP_LIKE`

</Accordion>

<Accordion title="REGEXP_REPLACE (expr, regex [, replace [, position [, occurrence [, mode]]]])">
...
<Accordion title="REGEXP_SUBSTR (expr, regex [, position [, occurrence [, mode [,group]]]])">
...
<Accordion title="REPLACE(expr, match, repl)">

Replaces every occurrence of `match` in `expr` with `repl`

</Accordion>

<Accordion title="REPLACE_CHAR(expr, match, repl)">
...
<Accordion title="REPLACE_TRUNCATE(expr, match, repl)">
...
<Accordion title="RIGHT(expr, num_bytes)">

Returns the rightmost `num_bytes` bytes from `expr`

</Accordion>

<Accordion title="RPAD(expr, length, pad)">
...
<Accordion title="RTRIM(expr)">

Removes whitespace from the right side of `expr`

</Accordion>

<Accordion title="SOUNDEX(expr)">
...
<Accordion title="SPLIT(expr, delim, group_num)">
...
<Accordion title="STARTS_WITH(match, expr)">
...
<Accordion title="STRCMP(expr_a, expr_b)">
...
<Accordion title="SUBSTR(expr, start_pos[, num_chars])">

Alias for `SUBSTRING`

</Accordion>

<Accordion title="SUBSTRING(expr, start_pos[, num_bytes])">
...
<Accordion title="TO_HEX(expr[, minimum_digits])">

Alias for `HEX`

</Accordion>

<Accordion title="TRIM(expr)">

Removes whitespace from both sides of `expr`

</Accordion>

<Accordion title="UCASE(expr)">

Converts `expr` to uppercase

</Accordion>

<Accordion title="UNHEX(expr)">
...
<Accordion title="CURRENT_SCHEMA()">

Returns the default schema of the current user

</Accordion>

<Accordion title="CURRENT_USER()">

Alias for `USER`

</Accordion>

<Accordion title="HASH(column[, seed])">
...
<Accordion title="IS_MEMBER(role[, user/role])">
...
<Accordion title="IS_ROLEMEMBER(role[, user/role])">

Alias for `IS_MEMBER`

</Accordion>

<Accordion title="MASK(expr, start, length[, char])">
...
<Accordion title="NEW_UUID()">

Returns a randomly-generated UUID

</Accordion>

<Accordion title="OBFUSCATE(column[, seed])">

Alias for `HASH`

</Accordion>

<Accordion title="SHA256(expr)">
...
<Accordion title="APPROX_COUNT_DISTINCT(expr)">
...
<Accordion title="APPROX_MEDIAN(expr)">
...
<Accordion title="APPROX_PERCENTILE(expr, p)">
...
<Accordion title="ARG_MAX(agg_expr, ret_expr)">
...
<Accordion title="ARG_MIN(agg_expr, ret_expr)">
...
<Accordion title="CORR(expr1, expr2)">
...
<Accordion title="CORRELATION(expr1, expr2)">

Alias for `CORR`

</Accordion>

<Accordion title="CORRCOEF(expr1, expr2)">
...
<Accordion title="COUNT(DISTINCT expr)">
...
<Accordion title="COV(expr1, expr2)">

Alias for `COVAR_POP`

</Accordion>

<Accordion title="COVAR(expr1, expr2)">

Alias for `COVAR_POP`

</Accordion>

<Accordion title="COVARIANCE(expr1, expr2)">

Alias for `COVAR_POP`

</Accordion>

<Accordion title="COVAR_POP(expr1, expr2)">
...
<Accordion title="COVAR_SAMP(expr1, expr2)">

Calculates the sample covariance of `expr1` and `expr2`

</Accordion>

<Accordion title="FIRST(ret_expr, agg_expr)">
...
<Accordion title="KURT(expr)">

Alias for `KURTOSIS_POP`

</Accordion>

<Accordion title="KURTOSIS(expr)">

Alias for `KURTOSIS_POP`

</Accordion>

<Accordion title="KURTOSIS_POP(expr)">

Calculate the population kurtosis of `expr`

</Accordion>

<Accordion title="KURTOSIS_SAMP(expr)">

Calculate the sample kurtosis of `expr`

</Accordion>

<Accordion title="KURT_POP(expr)">

Alias for `KURTOSIS_POP`

</Accordion>

<Accordion title="KURT_SAMP(expr)">

Alias for `KURTOSIS_SAMP`

</Accordion>

<Accordion title="LAST(ret_expr, agg_expr)">
...
<Accordion title="REGR_COUNT(y, x)">
...
<Accordion title="REGR_INTERCEPT(y, x)">
...
<Accordion title="REGR_SLOPE(y, x)">
...
<Accordion title="SKEW(expr)">

Alias for `SKEWNESS_POP`

</Accordion>

<Accordion title="SKEWNESS(expr)">

Alias for `SKEWNESS_POP`

</Accordion>

<Accordion title="SKEWNESS_POP(expr)">

Calculate the population skew of `expr`

</Accordion>

<Accordion title="SKEWNESS_SAMP(expr)">

Calculate the sample skew of `expr`

</Accordion>

<Accordion title="SKEW_POP(expr)">

Alias for `SKEWNESS_POP`

</Accordion>

<Accordion title="SKEW_SAMP(expr)">
...
<Accordion title="VARIANCE(expr)">

Alias for `VAR`

</Accordion>

<Accordion title="VARIANCE_POP(expr)">

Alias for `VAR_POP`

</Accordion>

<Accordion title="VARIANCE_SAMP(expr)">
...
<Accordion title="KI_SHARD_KEY(&lt;column list&gt;)">
...
<Accordion title="KI_HINT_DELTA_TABLE">
...
<Accordion title="KI_HINT_GROUP_BY_PK">
...
<Accordion title="KI_HINT_MATERIALIZE">
...
<Accordion title="KI_HINT_NO_VIRTUAL_UNION">
...
<Accordion title="KI_HINT_BATCH_SIZE(n)">
...
<Accordion title="KI_HINT_CHUNK_SIZE(n)">
...
<Accordion title="KI_HINT_COST_BASED_OPTIMIZATION">
...
<Accordion title="KI_HINT_DICT_PROJECTION">
...
<Accordion title="KI_HINT_DISTRIBUTED_OPERATIONS">
...
<Accordion title="KI_HINT_DONT_COMBINE">

Don't combine joins and unions for this query.

</Accordion>

<Accordion title="KI_HINT_GROUP_BY_FORCE_REPLICATED">
...
<Accordion title="KI_HINT_HAS_HEADER">
...
<Accordion title="KI_HINT_IGNORE_EXISTING_PK">
...
<Accordion title="KI_HINT_INDEX(column_list)">
...
<Accordion title="KI_HINT_JOIN_TABLE_CHUNK_SIZE(n)">
...
<Accordion title="KI_HINT_KEEP_TEMP_TABLES">

Don't erase temp tables created by this query.

</Accordion>

<Accordion title="KI_HINT_KEY_LOOKUP">
...
<Accordion title="KI_HINT_NO_COST_BASED_OPTIMIZATION">

Don't use the cost-based optimizer when calculating the query plan.

</Accordion>

<Accordion title="KI_HINT_NO_DICT_PROJECTION">
...
<Accordion title="KI_HINT_NO_DISTRIBUTED_OPERATIONS">
...
<Accordion title="KI_HINT_NO_HEADER">
...
<Accordion title="KI_HINT_PROJECT_MATERIALIZED_VIEW">
...
<Accordion title="KI_HINT_REPL_ASYNC">
...
<Accordion title="KI_HINT_REPL_ASYNC_PARALLEL">
...
<Accordion title="KI_HINT_REPL_NONE">
...
<Accordion title="KI_HINT_REPL_SYNC">
...
<Accordion title="KI_HINT_REPL_SYNC_PARALLEL">
...
<Accordion title="KI_HINT_REQUEST_TIMEOUT(m)">

Use a timeout of `m` minutes when processing this command.

</Accordion>

<Accordion title="KI_HINT_SAVE_UDF_STATS">

Save statistics of UDF runs for UDFs invoked via SQL.

</Accordion>

<Accordion title="KI_HINT_SERVER_SIDE_INSERT">
...
<Accordion title="KI_HINT_TRUNCATE_STRINGS">
...
<Accordion title="KI_HINT_UPDATE_ON_EXISTING_PK">
...
<Accordion title="KI_HINT_WAL_SYNC_METHOD(method)">
...
<Accordion title="KI_HINT_NO_CHUNK_SKIPPING">
...
<Accordion title="KI_HINT_NO_CONSTANT_FOLDING">

Do not use constant-folding optimizations when performing this query.

</Accordion>

<Accordion title="KI_HINT_NO_HAVING_PUSHDOWN">

Do not push down any `HAVING` clauses when planning this query.

</Accordion>

<Accordion title="KI_HINT_NO_TRANSITIVE_SIMPLIFICATIONS">
