...
<Accordion title="enable_audit" defaultOpen>

Enable or disable auditing.

</Accordion>

<Accordion title="audit_headers" defaultOpen>

Enable or disable auditing of request headers.

</Accordion>

<Accordion title="audit_body" defaultOpen>

Enable or disable auditing of request bodies.

</Accordion>

<Accordion title="audit_data" defaultOpen>

Enable or disable auditing of request data.

</Accordion>

<Accordion title="audit_response" defaultOpen>

Enable or disable auditing of response information.

</Accordion>

<Accordion title="tps_per_tom" defaultOpen>
...
<Accordion title="tcs_per_tom" defaultOpen>
...
<Accordion title="subtask_concurrency_limit" defaultOpen>
...
<Accordion title="concurrent_kernel_execution" defaultOpen>

Enable or disable concurrent kernel execution.

</Accordion>

<Accordion title="max_concurrent_kernels" defaultOpen>
...
<Accordion title="max_get_records_size" defaultOpen>
...
<Accordion title="request_timeout" defaultOpen>
...
<Accordion title="enable_overlapped_equi_join" defaultOpen>

Enable or disable the overlapped-equi-join filter.

</Accordion>

<Accordion title="chunk_size" defaultOpen>

Number of records per chunk, applied to all new tables.  To disable chunking, use `0`.

</Accordion>

<Accordion title="chunk_column_max_memory" defaultOpen>
...
<Accordion title="chunk_max_memory" defaultOpen>
...
<Accordion title="shadow_agg_size" defaultOpen>
...
<Accordion title="shadow_filter_size" defaultOpen>
...
<Accordion title="telm_persist_query_metrics" defaultOpen>
...
<Accordion title="postgres_proxy_idle_connection_timeout" defaultOpen>

PostgreSQL Wire Protocol service idle connection timeout, in seconds

</Accordion>

<Accordion title="postgres_proxy_keep_alive" defaultOpen>

Enable or disable PostgreSQL Wire Protocol service's keep alive.

</Accordion>

<Accordion title="ai_enable_rag" defaultOpen>
...
<Accordion title="ai_api_key" defaultOpen>

AI API key

</Accordion>

<Accordion title="ai_api_embeddings_model" defaultOpen>

AI API embeddings model name

</Accordion>

<Accordion title="ai_api_connection_timeout" defaultOpen>

AI API connection timeout, in seconds

</Accordion>

<Accordion title="external_files_directory" defaultOpen>
...
<Accordion title="egress_single_file_max_size" defaultOpen>
...
<Accordion title="egress_parquet_compression" defaultOpen>
...
<Accordion title="kafka_batch_size" defaultOpen>
...
<Accordion title="kafka_wait_time" defaultOpen>
...
<Accordion title="kafka_poll_timeout" defaultOpen>
...
<Accordion title="system_metadata_retention_period" defaultOpen>
...
<Accordion title="kifs_directory_data_limit" defaultOpen>
...
<Accordion title="enable_one_step_compound_equi_join" defaultOpen>
