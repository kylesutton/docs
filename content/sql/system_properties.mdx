...
<Accordion title="subtask_concurrency_limit">
...
<Accordion title="concurrent_kernel_execution">

Enable or disable concurrent kernel execution.

</Accordion>

<Accordion title="max_concurrent_kernels">
...
<Accordion title="max_get_records_size">
...
<Accordion title="chunk_max_memory">
...
<Accordion title="shadow_agg_size">
...
<Accordion title="shadow_filter_size">
...
<Accordion title="telm_persist_query_metrics">
...
<Accordion title="ai_api_key">

AI API key

</Accordion>

<Accordion title="ai_api_embeddings_model">

AI API embeddings model name

</Accordion>

<Accordion title="ai_api_connection_timeout">

AI API connection timeout, in seconds

</Accordion>

<Accordion title="external_files_directory">
...
<Accordion title="egress_single_file_max_size">
...
<Accordion title="egress_parquet_compression">
...
<Accordion title="kafka_batch_size">
...
<Accordion title="kafka_wait_time">
...
<Accordion title="kafka_poll_timeout">
...
<Accordion title="system_metadata_retention_period">
...
<Accordion title="kifs_directory_data_limit">
...
<Accordion title="enable_one_step_compound_equi_join">
