...
<Accordion title="&lt;function name&gt;" defaultOpen>

Name of the UDF, which can be referenced in subsequent commands

</Accordion>

<Accordion title="RETURNS TABLE" defaultOpen>
...
<Accordion title="RUN_COMMAND" defaultOpen>

The command used to execute the files associated with the UDF; e.g., `python`

</Accordion>

<Accordion title="RUN_COMMAND_ARGS" defaultOpen>
...
<Accordion title="VERBOSE" defaultOpen>

Specifies verbose output mode.  This modifies the response as noted below.

</Accordion>

<Accordion title="FOR '&lt;run ID&gt;'" defaultOpen>
...
<Accordion title="&lt;environment name&gt;" defaultOpen>
...
<Accordion title="&lt;package name&gt;" defaultOpen>

Name of the Python package to install into or uninstall from the UDF environment

</Accordion>

<Accordion title="&lt;package version&gt;" defaultOpen>
