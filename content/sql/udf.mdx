...
| `MODE` | Name of the execution mode for the UDF; the following modes are available: <br/> <br/> `DISTRIBUTED`: The function's processing will be distributed among the nodes in the cluster <br/> `NONDISTRIBUTED`: The function's processing will be completed on a single node in the cluster |
