...
<table class="table w-full [&_td]:min-w-[150px] [&_th]:text-left [&_td[data-numeric]]:tabular-nums">
  ...
  <tr>
    ...
    <td>Indicates which result table to return results from: * <code>1</code> - Return *edge* results *(default)* * <code>2</code> - Return *node* results <Note>Only applicable when using the table function syntax</Note></td>
  </tr>
  <tr>
