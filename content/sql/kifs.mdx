...
<Accordion title="&lt;directory name&gt;" defaultOpen>
...
<Accordion title="&lt;data limit value&gt;" defaultOpen>
...
<Accordion title="DIRECTORY" defaultOpen>

Optional keyword for clarity.

</Accordion>

<Accordion title="&lt;kifs directory&gt;" defaultOpen>

*KiFS directory* whose contained *files* will be downloaded to the local file system.

</Accordion>

<Accordion title="&lt;local directory&gt;" defaultOpen>
...
<Accordion title="&lt;file path(s)&gt;" defaultOpen>
...
<Accordion title="&lt;kifs path&gt;" defaultOpen>
...
<Accordion title="FILE[S]" defaultOpen>

Optional keyword for clarity.

</Accordion>

<Accordion title="&lt;kifs file path(s)&gt;" defaultOpen>
...
<Accordion title="IF EXIST[S]" defaultOpen>
