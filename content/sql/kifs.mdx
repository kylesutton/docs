...
<Accordion title="&lt;directory name&gt;">
...
<Accordion title="&lt;data limit value&gt;">
...
<table class="table w-full [&_td]:min-w-[150px] [&_th]:text-left [&_td[data-numeric]]:tabular-nums">
  ...
  <tr>
    ...
    <td>Whether to delete all files contained within the *directory*: * <code>false</code> *(default)* - only drop the *directory* if empty; return an error if the *directory* contains *files* * <code>true</code> - drop the *directory* and all *files* in it</td>
  </tr>
  </tbody>
</table>
</div>
...
<Accordion title="FILE[S]">

Optional keyword for clarity.

</Accordion>

<Accordion title="&lt;kifs file path(s)&gt;">
