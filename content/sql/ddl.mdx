...
<Accordion title="&lt;column definition&gt;">
...
<Accordion title="COMMENT '&lt;column comment&gt;'">
...
<Accordion title="PRIMARY KEY (&lt;column list&gt;)">
...
<Accordion title="SHARD KEY (&lt;column list&gt;)">
...
<Accordion title="&lt;table property clause&gt;">
...
<Accordion title="CHUNK COLUMN MEMORY">
...
<Accordion title="COMPRESSION_CODEC">
...
<Accordion title="NO_ERROR_IF_EXISTS">
...
<Accordion title="PRIMARY_KEY_TYPE">
...
<Accordion title="&lt;table definition clause&gt;">
...
<Accordion title="COMMENT = '&lt;string&gt;'">
...
<Accordion title="DELIMITER = '&lt;char&gt;'">
...
<Accordion title="HEADER DELIMITER = '&lt;char&gt;'">
...
<Accordion title="INCLUDES HEADER = &lt;TRUE|FALSE&gt;">
...
<Accordion title="BAD RECORD TABLE">
...
<Accordion title="COLUMN FORMATS">
...
<Accordion title="DEFAULT COLUMN FORMATS">
...
<Accordion title="FIELDS IGNORED BY">
...
<Accordion title="FIELDS MAPPED BY">
...
<Accordion title="FLATTEN_COLUMNS">
...
<Accordion title="IGNORE_EXISTING_PK">
...
<Accordion title="INGESTION MODE">
...
<Accordion title="JDBC_FETCH_SIZE">
...
<Accordion title="NUM_SPLITS_PER_RANK">
...
<Accordion title="NUM_TASKS_PER_RANK">
...
<Accordion title="JDBC_SESSION_INIT_STATEMENT">
...
<Accordion title="REFRESH ON START">
...
<Accordion title="REMOTE_QUERY_INCREASING_COLUMN">
...
<Accordion title="REMOTE_QUERY_NO_SPLIT">
...
<Accordion title="REMOTE_QUERY_ORDER_BY">
...
<Accordion title="REMOTE_QUERY_PARTITION_COLUMN">
...
<Accordion title="TRUNCATE_STRINGS">
...
<Accordion title="TYPE_INFERENCE_MODE">
...
<Accordion title="UPDATE_ON_EXISTING_PK">
...
<Accordion title="&lt;view name&gt;">

Name of the *table* to repair

</Accordion>

<Accordion title="REPAIR_POLICY">
...
<table class="table w-full [&_td]:min-w-[150px] [&_th]:text-left [&_td[data-numeric]]:tabular-nums">
  ...
  <tr>
    ...
    <td>Executes *materialized view* refreshes as the given user with that user's privileges, when <code>EVERY ...</code> is specified as the <code>REFRESH</code> method. .. note::  If this user doesn't exist at the time of a refresh, the refresh will be executed as the creating user, and, failing that, the system administration user.</td>
  </tr>
  </tbody>
</table>
</div>
...
<Accordion title="&lt;credential name&gt;">
...
<table class="table w-full [&_td]:min-w-[150px] [&_th]:text-left [&_td[data-numeric]]:tabular-nums">
  ...
  <tr>
    <td><code>CONFLUENT</code></td>
    <td>Confluent Kafka streaming feed .. note::  The <code>LOCATION</code> can be a comma-delimited list of Kafka URLs, to be used for high-availability; only one of which will be streamed from at any given time.</td>
  </tr>
  <tr>
    <td><code>GCS</code></td>
  ...
  <tr>
    <td><code>KAFKA</code></td>
    <td>Apache Kafka streaming feed .. note::  The <code>LOCATION</code> can be a comma-delimited list of Kafka URLs, to be used for high-availability; only one of which will be streamed from at any given time.</td>
  </tr>
  <tr>
    <td><code>S3</code></td>
...
<Accordion title="&lt;data sink name&gt;">
...
<Accordion title="&lt;stream schema name&gt;">
...
<Accordion title="&lt;table schema name&gt;">
...
<Accordion title="&lt;filter expression&gt;">
