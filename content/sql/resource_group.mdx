...
<Accordion title="&lt;resource group name&gt;">
...
<table class="table w-full [&_td]:min-w-[150px] [&_th]:text-left [&_td[data-numeric]]:tabular-nums">
  ...
  <tr>
    ...
    <td>Name of the *tier* to which limits will be assigned: +----------+-----------------------------------------------------+ +==========+=====================================================+ +----------+-----------------------------------------------------+ +----------+-----------------------------------------------------+</td>
  </tr>
  <tr>
    <td><code>tier property name</code></td>
    <td>Name of the *tier* property to which a limit will be assigned: +----------+-----------------------------------------------------+ +==========+=====================================================+ +----------+-----------------------------------------------------+</td>
  </tr>
  <tr>
...
<Accordion title="max_cpu_concurrency">
