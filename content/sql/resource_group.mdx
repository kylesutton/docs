...
<Accordion title="&lt;resource group name&gt;" defaultOpen>
...
<Accordion title="TIER LIMITS" defaultOpen>
...
<Accordion title="max_cpu_concurrency" defaultOpen>
...
<Accordion title="max_data" defaultOpen>
...
<Accordion title="max_scheduling_priority" defaultOpen>

Maximum [scheduling priority](/content/rm/concepts#rm-concepts-scheduling-priority) of a task.

</Accordion>

<Accordion title="max_tier_priority" defaultOpen>
...
<Accordion title="persist" defaultOpen>
...
<Accordion title="&lt;tier name&gt;" defaultOpen>
