...
<Accordion title="&lt;procedure name&gt;">
...
<Accordion title="EXECUTE FOR EVERY">
...
<table class="table w-full [&_td]:min-w-[150px] [&_th]:text-left [&_td[data-numeric]]:tabular-nums">
  ...
  <tr>
    ...
    <td>Executes the *SQL procedure* as the given user with that user's privileges. .. note::  If this user doesn't exist at the time of execution, the *SQL procedure* will be executed as the creating user, and and, failing that, the system administration user.</td>
  </tr>
  </tbody>
</table>
</div>
