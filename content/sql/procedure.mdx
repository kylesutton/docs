...
| `WITH OPTIONS` | Optional indicator that a comma-delimited list of option/value assignments will follow. The following options are available: <br/> <br/> `EXECUTE AS`: Executes the *SQL procedure* as the given user with that user's privileges. **Note:** If this user doesn't exist at the time of execution, the *SQL procedure* will be executed as the creating user, and and, failing that, the system administration user. |
