...
| `WITH OPTIONS` | Optional indicator that a comma-delimited list of SQL generation option/value assignments will follow. <br/> See [SQL Generation Options](/content/sql/sqlgpt#sql-gpt-generate-sql-opts) for the complete list of options. |
...
| `context_names` | Comma-separated list of names of *SQL-GPT contexts* to use as a basis for generating SQL queries; each should be of the form `[<schema name>.]<context name>`, and the entire list should be single-quoted. <br/> For example: <br/> `context_names = 'example.atc_ctx,example.nyctaxi'` |
...
| `<question>` | Natural-language question for which an equivalent SQL query will be generated |
| `<schema name>` | Name of the [schema](/content/sql/ddl#sql-create-schema) containing the *context* to use in generating the query |
| `WITH OPTIONS` | Optional indicator that a comma-delimited list of SQL generation option/value assignments will follow. <br/> See [SQL Token Generation Options](/content/sql/sqlgpt#sql-gpt-generate-tokens-opts) for the complete list of options. |
...
| `context_names` | Comma-separated list of names of *SQL-GPT contexts* to use as the basis for counting generated tokens; each should be of the form `[<schema name>.]<context name>`, and the entire list should be single-quoted. <br/> For example: <br/> `context_names = 'example.atc_ctx,example.nyctaxi'` |
| `use_rag` | Whether to use [retrieval-augmented generation (RAG)](/content/sql-gpt/concepts#sql-gpt-overview-rag) facilities with the given *SQL-GPT contexts* when processing this request. |
...
| `context_names` | Comma-separated list of names of *SQL-GPT contexts* to use in generating the executed query; each should be of the form `[<schema name>.]<context name>`, and the entire list should be single-quoted. <br/> For example: <br/> `context_names = 'example.atc_ctx,example.nyctaxi'` |
| `use_rag` | Whether to use [retrieval-augmented generation (RAG)](/content/sql-gpt/concepts#sql-gpt-overview-rag) facilities with the given *SQL-GPT contexts* when processing this request. |
