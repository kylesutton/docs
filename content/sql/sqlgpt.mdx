...
| `<SQL answer>` | SQL query that answers `<question>` using the tables contained within the *context* <br/> <Info> Quoted constants within the query will need to be escaped as per standard SQL convention; e.g., `'lamp'` in the following: <br/> <br/> `'How many lamps?' = 'SELECT COUNT(*) FROM product WHERE type = ''lamp'';'` <br/> <br/> </Info> |
...
| `context_names` | Comma-separated list of names of *SQL-GPT contexts* to use as a basis for generating SQL queries; each should be of the form `[<schema name>.]<context name>`, and the entire list should be single-quoted. <br/> <br/> For example: <br/> <br/> `context_names = 'example.atc_ctx,example.nyctaxi'` <br/> |
...
| `context_names` | Comma-separated list of names of *SQL-GPT contexts* to use as the basis for counting generated tokens; each should be of the form `[<schema name>.]<context name>`, and the entire list should be single-quoted. <br/> <br/> For example: <br/> <br/> `context_names = 'example.atc_ctx,example.nyctaxi'` <br/> |
| `use_rag` | Whether to use [retrieval-augmented generation (RAG)](/content/sql-gpt/concepts#sql-gpt-overview-rag) facilities with the given *SQL-GPT contexts* when processing this request. |
...
| `<schema name>` | Name of the [schema](/content/sql/ddl#sql-create-schema) containing the *context* to use in generating the query |
| `OPTIONS` | [SQL generation options](/content/sql/sqlgpt#sql-gpt-execute-opts), specified as a set of key/value pairs passed as a comma-delimited list of `<key> = '<value>'` assignments to the `KV_PAIRS` function; e.g.: <br/> <br/> `KV_PAIRS(context_name = 'atc_ctx')` <br/> |
...
| `context_names` | Comma-separated list of names of *SQL-GPT contexts* to use in generating the executed query; each should be of the form `[<schema name>.]<context name>`, and the entire list should be single-quoted. <br/> <br/> For example: <br/> <br/> `context_names = 'example.atc_ctx,example.nyctaxi'` <br/> |
| `use_rag` | Whether to use [retrieval-augmented generation (RAG)](/content/sql-gpt/concepts#sql-gpt-overview-rag) facilities with the given *SQL-GPT contexts* when processing this request. |
