...
<Accordion title="FROM REMOTE QUERY">
...
<Accordion title="FROM FILE PATHS">
...
<Accordion title="KAFKA_CONSUMERS_PER_RANK">
...
<Accordion title="KAFKA_GROUP_ID">
...
<Accordion title="KAFKA_OPTIMISTIC_INGEST">
...
<Accordion title="KAFKA_OFFSET_RESET_POLICY">
...
<Accordion title="KAFKA_SUBSCRIPTION_CANCEL_AFTER">
...
<Accordion title="KAFKA_TYPE_INFERENCE_FETCH_TIMEOUT">
...
<Accordion title="MAX_RECORDS_TO_LOAD">
...
<Accordion title="SCHEMA_REGISTRY_SCHEMA_NAME">
...
<Accordion title="TRUNCATE_TABLE">
...
<Accordion title="&lt;file name | file name expression&gt;">
