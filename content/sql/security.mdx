...
| `<schema reference>` | Either the name of the schema to which access is being granted or a wildcard expression signifying the schema(s) and table(s)/views(s) to which access is being granted. <br/> <br/> `*`: All schemas currently in the database <br/> `*.*`: All schemas, tables, & views currently in the database |
| `<object type>` | For granting `CREATE` privilege, the object type to give permission to create in the given schema. <br/> Supported object types include: <br/> <br/> `CONTEXT`: [SQL-GPT context](/content/sql/sqlgpt#sql-gpt-create-context) object <br/> `CREDENTIAL`: [Credential](/content/sql/ddl#sql-create-credential) object <br/> `DATA SINK`: External [data sink](/content/sql/ddl#sql-create-data-sink) <br/> `DATA SOURCE`: External [data source](/content/sql/ddl#sql-create-data-source) <br/> `GRAPH`: [Graph](/content/sql/graph#sql-graph-create) <br/> `PROCEDURE`: SQL [stored procedure](/content/sql/procedure#sql-procedures) <br/> `STREAM`: [Stream](/content/sql/ddl#sql-create-stream) <br/> `TABLE`: [Table](/content/sql/ddl#sql-create-table) (or view) |
| `WITH GRANT OPTION` | Grant this permission with a [grant option](/content/security/sec_concepts#security-concepts-permissions-grant-option) to grant it to others. |
...
| `<object reference>` | The name of the table/view and/or schema to which access is being granted. the following forms are valid: <br/> <br/> *&lt;schema&gt;.&lt;object&gt;*: Fully-qualified table or view name in the specified schema <br/> `*.*`: All existing tables & views that the granting user can see across all schemas <br/> `*`: All existing schemas that the granting user can see, which will grant access to all tables and views in those schemas now and in the future <br/> *&lt;schema&gt;*: All tables and views in the specified schema now and in the future <br/> *&lt;object&gt;*: Table or view in the default schema. If a schema exists with the same name, it will be used. To avoid this, specify the fully-qualified object name. |
...
| Permission | Description |
| --- | --- |
| `ADMIN` | Drop the given *UDF*, and display full configuration about it (includes `EXECUTE` access). <br/> When `*` is used instead of *function name*, gives permission to manage [Python UDF function environments](/content/sql/udf#sql-create-function-environment). |
...
| `<schema reference>` | Either the name of the schema to which access is being revoked or a wildcard expression signifying the schema(s) and table(s)/views(s) to which access is being revoked <br/> <br/> `*`: All schemas currently in the database <br/> `*.*`: All schemas, tables, & views currently in the database |
| `<object type>` | For revoking `CREATE` privilege, the object type to remove permission to create in the given schema. <br/> Supported object types include: <br/> <br/> `CONTEXT`: [SQL-GPT context](/content/sql/sqlgpt#sql-gpt-create-context) object <br/> `CREDENTIAL`: [Credential](/content/sql/ddl#sql-create-credential) object <br/> `DATA SINK`: External [data sink](/content/sql/ddl#sql-create-data-sink) <br/> `DATA SOURCE`: External [data source](/content/sql/ddl#sql-create-data-source) <br/> `GRAPH`: [Graph](/content/sql/graph#sql-graph-create) <br/> `PROCEDURE`: SQL [stored procedure](/content/sql/procedure#sql-procedures) <br/> `STREAM`: [Stream](/content/sql/ddl#sql-create-stream) <br/> `TABLE`: [Table](/content/sql/ddl#sql-create-table) (or view) |
...
| Parameters | Description |
| --- | --- |
| `<permission>` | Permission to verify for the given user <br/> Supported permissions include: <br/> <br/> `ADMIN` \| `ALL`: Applicable to [credential](/content/sql/ddl#sql-create-credential) objects and [tables](/content/sql/ddl#sql-create-table) (or views) <br/> `CONNECT`: Applicable to external [data sources](/content/sql/ddl#sql-create-data-source) <br/> `DELETE`: Applicable to [tables](/content/sql/ddl#sql-create-table) <br/> `EXECUTE`: Applicable to [User-Defined Functions](/content/sql/udf#sql-udf) (UDFs) and SQL [stored procedures](/content/sql/procedure#sql-procedures) <br/> `INSERT`: Applicable to [tables](/content/sql/ddl#sql-create-table) <br/> `READ`: Applicable to [credential](/content/sql/ddl#sql-create-credential) objects <br/> `SELECT`: Applicable to [tables](/content/sql/ddl#sql-create-table) (or views) <br/> `SYSTEM ADMIN`: [System admin](/content/sql/security#sql-perm-system-admin) permission <br/> `SYSTEM CREATE`: [System create](/content/sql/security#sql-perm-system-mgmt) permission <br/> `SYSTEM MONITOR`: [System monitor](/content/sql/security#sql-perm-system-mgmt) permission <br/> `SYSTEM READ`: [System read](/content/sql/security#sql-perm-system-mgmt) permission <br/> `SYSTEM WRITE`: [System write](/content/sql/security#sql-perm-system-mgmt) permission <br/> `UPDATE`: Applicable to [tables](/content/sql/ddl#sql-create-table) <br/> `USER ADMIN`: [User admin](/content/sql/security#sql-perm-user-admin) permission |
...
| `<target type>` | Optional keyword for specifying the object type of the target; may be necessary to disambiguate same-named objects of differing types <br/> Supported target types include: <br/> <br/> `CONTEXT`: [SQL-GPT context](/content/sql/sqlgpt#sql-gpt-create-context) object <br/> `CREDENTIAL`: [Credential](/content/sql/ddl#sql-create-credential) object <br/> `DATA SINK`: External [data source](/content/sql/ddl#sql-create-data-source) <br/> `DATA SOURCE`: External [data source](/content/sql/ddl#sql-create-data-source) <br/> `DIRECTORY`: [KiFS](/content/tools/kifs) directory <br/> `FUNCTION`: [User-Defined Function](/content/sql/udf#sql-udf) (UDF) <br/> `GRAPH`: [Graph](/content/sql/graph#sql-graph-create) <br/> `PROCEDURE`: SQL [stored procedure](/content/sql/procedure#sql-procedures) <br/> `SCHEMA`: [Schema](/content/sql/ddl#sql-create-schema) <br/> `STREAM`: [Stream](/content/sql/ddl#sql-create-stream) <br/> `TABLE`: [Table](/content/sql/ddl#sql-create-table) (or view) |
