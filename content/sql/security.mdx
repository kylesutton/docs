...
<Accordion title="WITH GRANT OPTION">
...
<Accordion title="&lt;object reference&gt;">
...
<Accordion title="WHERE &lt;expression&gt;">
...
<Accordion title="&lt;table/view name&gt;">
...
<table class="table w-full [&_td]:min-w-[150px] [&_th]:text-left [&_td[data-numeric]]:tabular-nums">
  ...
  <tr>
    ...
    <td>[tables](/content/sql/ddl#sql-create-table) (or views)</td>
  </tr>
  <tr>
