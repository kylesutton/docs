...
All permissions (except [system_admin](#system-admin) & [system_user_admin](#system-user-admin)) may be granted
...
also grant a subset of that permission to others.  Both [system_admin](#system-admin) &
[system_user_admin](#system-user-admin) permissions have the ability to grant permissions
...
* [system_user_admin](#system-user-admin)
...
* has [system_write](#system-write)
* has [system_user_admin](#system-user-admin)
...
* manage users & roles
* grant/revoke permissions & roles *(except the* [system_admin](#system-admin)
...
* has [directory_create](#directory-create)
* has [proc_create](#proc-create)
...
* has [system_create](#system-create)
* has [system_read](#system-read)
...
<Note>
For granting the ability to create *UDFs*, see [proc_create](#proc-create).
</Note>
...
with the [system_admin](#system-admin) permission.
</Info>
...
Calling permission endpoints generally requires [system_admin](#system-admin) or
[system_user_admin](#system-user-admin) permission.
...
* [/show/security](/content/api/rest/show_security_rest) *(can be called by users without*
  [system_admin](#system-admin) or [system_user_admin](#system-user-admin) *permission to view the*
