...
<img src="/content/connectors/FMEReaderParams.jpg" alt="reader_params" style={{display: "inline", margin: 0, verticalAlign: "middle"}} />
...
<img src="/content/connectors/FMEReader.jpg" alt="reader_add" style={{display: "inline", margin: 0, verticalAlign: "middle"}} />
...
<img src="/content/connectors/FMEWriterParams.jpg" alt="writer_params" style={{display: "inline", margin: 0, verticalAlign: "middle"}} />
...
<img src="/content/connectors/FMEWriter.jpg" alt="writer_add" style={{display: "inline", margin: 0, verticalAlign: "middle"}} />
...
the gear <img src="/content/connectors/FMEgear.png" alt="gear" style={{display: "inline", margin: 0, verticalAlign: "middle"}} /> button on a feature type in the workspace. These parameters
are applicable only to the selected feature type.

The *User Attributes* of the *Feature Type* are listed on the
**User Attributes** tab.

<img src="/content/connectors/FMEFeatureTypeProperties.jpg" alt="feature_type_props" style={{display: "inline", margin: 0, verticalAlign: "middle"}} />
