...
<img src="/content/connectors/FMEReaderParams.jpg" alt="reader_params" width="424" height="249" style={{display: "inline", margin: 0, verticalAlign: "middle"}} />
...
<img src="/content/connectors/FMEReader.jpg" alt="reader_add" width="418" height="241" style={{display: "inline", margin: 0, verticalAlign: "middle"}} />
...
<img src="/content/connectors/FMEWriterParams.jpg" alt="writer_params" width="344" height="345" style={{display: "inline", margin: 0, verticalAlign: "middle"}} />
...
<img src="/content/connectors/FMEWriter.jpg" alt="writer_add" width="355" height="247" style={{display: "inline", margin: 0, verticalAlign: "middle"}} />
...
the gear <img src="/content/connectors/FMEgear.png" alt="gear" width="20" height="20" style={{display: "inline", margin: 0, verticalAlign: "middle"}} /> button on a feature type in the workspace. These parameters
are applicable only to the selected feature type.

The *User Attributes* of the *Feature Type* are listed on the
**User Attributes** tab.

<img src="/content/connectors/FMEFeatureTypeProperties.jpg" alt="feature_type_props" width="807" height="682" style={{display: "inline", margin: 0, verticalAlign: "middle"}} />
