...
[/create/trigger/byrange](/content/api/rest/create_trigger_byrange_rest#create-trigger-byrange-rest).) Once the
trigger has been activated, any record added to the listed tables(s) via
[/insert/records](/content/api/rest/insert_records_rest#insert-records-rest) with the chosen columns'
...
retrieved via [/show/system/status](/content/api/rest/show_system_status_rest#show-system-status-rest)) for
any listening client to collect. Active triggers can be cancelled by using the
[/clear/trigger](/content/api/rest/clear_trigger_rest#clear-trigger-rest) endpoint or by clearing all
relevant tables.
