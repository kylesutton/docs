...
| data_str | JSON or | This embedded JSON represents the result of the /create/trigger/byarea endpoint: <br/> <br/> trigger_id: [string] Value of input parameter *request_id*. <br/> info: [map of string to strings] Additional information. <br/> Empty string in case of an error. |
