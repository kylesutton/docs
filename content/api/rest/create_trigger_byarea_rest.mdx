...
| data_str | JSON or String | This embedded JSON represents the result of the /create/trigger/byarea endpoint: <br/> <br/> trigger_id: [string] Value of input parameter *request_id*. <br/> <br/> info: [map of string to strings] Additional information. <br/> <br/> Empty string in case of an error. |
