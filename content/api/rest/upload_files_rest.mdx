...
directories listed in [/show/directories](/content/api/rest/show_directories_rest#show-directories-rest).
...
| data_str | JSON or String | This embedded JSON represents the result of the /upload/files endpoint: <br/> <br/> info: [map of string to strings] Additional information. <br/> <br/> Empty string in case of an error. |
