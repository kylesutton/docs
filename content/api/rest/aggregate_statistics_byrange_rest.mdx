...
| data_str | JSON or | This embedded JSON represents the result of the /aggregate/statistics/byrange endpoint: <br/> <br/> stats: [map of string to arrays of doubles] A map with a key for each statistic in the stats input parameter having a value that is a vector of the corresponding value-column bin statistics. In a addition the key count has a value that is a histogram of the binning-column. <br/> info: [map of string to strings] Additional information. <br/> Empty string in case of an error. |
