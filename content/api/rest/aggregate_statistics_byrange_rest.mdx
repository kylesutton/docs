...
| options | map of string to strings | Map of optional parameters:.  The default value is an empty map ( \{\} ). <br/> <br/> additional_column_names: A list of comma separated value-column names over which statistics can be accumulated along with the primary value_column. <br/> <br/> bin_values: A list of comma separated binning-column values. Values that match the nth bin_values value are placed in the nth bin. <br/> <br/> weight_column_name: Name of the column used as weighting column for the weighted_average statistic. <br/> <br/> order_column_name: Name of the column used for candlestick charting techniques. |
