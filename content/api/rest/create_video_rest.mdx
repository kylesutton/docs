...
| style | string | The name of the visualize mode; should correspond to the schema used for the input parameter *style_parameters* field. <br/> <br/> The supported values are: <br/> <br/> * chart <br/> * raster <br/> * classbreak <br/> * contour <br/> * heatmap <br/> * labels |
...
| data_str | JSON or String | This embedded JSON represents the result of the /create/video endpoint: <br/> <br/> job_id: [long] An identifier for the created job. <br/> <br/> path: [string] Fully qualified KIFS path to the video file. <br/> <br/> info: [map of string to strings] Additional information. <br/> <br/> Empty string in case of an error. |
