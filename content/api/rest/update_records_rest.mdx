...
| data_str | JSON or | This embedded JSON represents the result of the /update/records endpoint: <br/> <br/> count_updated: [long] Total number of records updated. <br/> counts_updated: [array of longs] Total number of records updated per predicate in input parameter *expressions*. <br/> count_inserted: [long] Total number of records inserted (due to expressions not matching any existing records). <br/> counts_inserted: [array of longs] Total number of records inserted per predicate in input parameter *expressions* (will be either 0 or 1 for each expression). <br/> info: [map of string to strings] Additional information. <br/> Empty string in case of an error. |
