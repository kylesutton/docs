...
| data_str | JSON or | This embedded JSON represents the result of the /show/tables/bytype endpoint: <br/> <br/> table_names: [array of strings] List of tables matching the input criteria. <br/> info: [map of string to strings] Additional information. <br/> Empty string in case of an error. |
