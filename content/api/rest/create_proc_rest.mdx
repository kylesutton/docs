...
| data_str | JSON or | This embedded JSON represents the result of the /create/proc endpoint: <br/> <br/> proc_name: [string] Value of input parameter *proc_name*. <br/> info: [map of string to strings] Additional information. <br/> Empty string in case of an error. |
