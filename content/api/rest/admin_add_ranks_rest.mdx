...
| data_str | JSON or | This embedded JSON represents the result of the /admin/add/ranks endpoint: <br/> <br/> added_ranks: [array of strings] The number assigned to each added rank, formatted as 'rankN', in the same order as the ranks in input parameter *hosts* and input parameter *config_params*. <br/> info: [map of string to strings] Additional information. <br/> Empty string in case of an error. |
