...
| data_str | JSON or String | This embedded JSON represents the result of the /aggregate/histogram endpoint: <br/> <br/> counts: [array of doubles] The array of calculated values that represents the histogram data points. <br/> <br/> start: [double] Value of input parameter *start*. <br/> <br/> end: [double] Value of input parameter *end*. <br/> <br/> info: [map of string to strings] Additional information. <br/> <br/> Empty string in case of an error. |
