...
| data_str | JSON or | This embedded JSON represents the result of the /clear/trigger endpoint: <br/> <br/> trigger_id: [string] Value of input parameter *trigger_id*. <br/> info: [map of string to strings] Additional information. <br/> Empty string in case of an error. |
