...
[API Download and Installation](#api-download-and-installation) section.
...
created in the [Initialization (udf_tc_py_manager.py init)](#initialization-(udf-tc-py-manager.py-init)) section are passed
in here:
