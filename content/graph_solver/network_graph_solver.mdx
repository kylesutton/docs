...
| `WKTPOINT` | `wkt` | A WKT string representing a node's geospatial point; e.g., `POINT(X Y [Z])` <br/> See [Geospatial Objects](/content/location_intelligence/geo_objects) for more information on WKTs. |
...
| `DIRECTION` | `int` | A number representing what direction the edge can be traveled: <br/> * `0`: forward one-way edge (**node 1 --&gt; node 2**) <br/> * `1`: two-way edge (**node 1 --&gt; node 2** and **node 2 --&gt; node 1**) <br/> * `2`: backward one-way edge (**node 2 --&gt; node 1**) |
...
| `NODE1_WKTPOINT` | `wkt` | A WKT string representing the edge's first node's geospatial point; e.g., `POINT(X1 Y1 [Z1])` <br/> See [Geospatial Objects](/content/location_intelligence/geo_objects) for more information on WKTs. |
...
| `NODE2_WKTPOINT` | `wkt` | A WKT string representing the edge's second node's geospatial point; e.g., `POINT(X2 Y2 [Z2])` <br/> See [Geospatial Objects](/content/location_intelligence/geo_objects) for more information on WKTs. |
...
| `WKTLINE` | `wkt` | A WKT string representing an edge's geospatial line; e.g., `LINESTRING(X1 Y1 [Z1], X2 Y2 [Z2])` <br/> See [Geospatial Objects](/content/location_intelligence/geo_objects) for more information on WKTs. |
...
| Identifier | Supported Types | Description |
| --- | --- | --- |
| `EDGE_DIRECTION` | `int` | A number representing what direction the edge can be traveled: <br/> * `0`: forward one-way edge (**node 1 --&gt; node 2**) <br/> * `1`: two-way edge (**node 1 --&gt; node 2** and **node 2 --&gt; node 1**) <br/> * `2`: backward one-way edge (**node 2 --&gt; node 1**) |
...
| `EDGE_WKTLINE` | `wkt` | A WKT string representing a weight's associated edge geospatial line; e.g., `LINESTRING(X1 Y1 [Z1], X2 Y2 [Z2])` <br/> See [Geospatial Objects](/content/location_intelligence/geo_objects) for more information on WKTs. |
...
| `NODE_WKTPOINT` | `wkt` | A WKT string representing the restriction's associated node's geospatial point, e.g., `POINT(X Y [Z])` <br/> See [Geospatial Objects](/content/location_intelligence/geo_objects) for more information on WKTs. |
...
| ``EDGE_LABEL`` | ``string`` | Defines the edge ``LABEL`` value that will be matched against in the source graph to determine the source(s) for the query <br/> See [Using Labels](/content/graph_solver/network_graph_solver#using-labels) for more information. |
...
| ``HOP_ID`` | ``int``, ``long`` | Defines the number of hops from the source node or edge at which the associated node or edge filter should be applied; use a negative number to allow directed edges to be traversed in the reverse direction for that hop number specifically <br/> See [Using Hops](/content/graph_solver/network_graph_solver#query-using-hops) for more information. |
...
| ``NODE_LABEL`` | ``string`` | Defines the node ``LABEL`` value that will be matched against in the source graph to determine the source(s) for the query <br/> See [Using Labels](/content/graph_solver/network_graph_solver#using-labels) for more information. |
...
| ``DESTINATION_WKTPOINT`` | ``wkt`` | A WKT string representing a sample's geospatial destination point; e.g., ``POINT(X Y [Z])`` <br/> See [Geospatial Objects](/content/location_intelligence/geo_objects) for more information on WKTs. |
...
| ``ORIGIN_WKTPOINT`` | ``wkt`` | A WKT string representing a sample's geospatial origin point; e.g., ``POINT(X Y [Z])`` <br/> See [Geospatial Objects](/content/location_intelligence/geo_objects) for more information on WKTs. |
...
| ``SUPPLY_ODDEVEN`` | ``int`` | A number representing whether the supplier is "odd", "even", or neither; used in applying odd/even-based restrictions, such as those used in Jakarta, Indonesia: <br/> * ``0``: supplier is not subject to odd/even-based restrictions <br/> * ``1``: supplier is "odd" numbered <br/> * ``2``: supplier is "even" numbered |
...
| ``WKTPOINT`` | ``wkt`` | A WKT string representing a sample's geospatial point; e.g., ``POINT(X Y [Z])`` <br/> See [Geospatial Objects](/content/location_intelligence/geo_objects) for more information on WKTs. |
