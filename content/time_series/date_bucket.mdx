...
<Accordion title="width" defaultOpen>

The number of days each bucket should span.  An `INTERVAL` can also be used to specify
the `width`.

</Accordion>

<Accordion title="timestamp" defaultOpen>
...
<Accordion title="offset" defaultOpen>

The number of days after (for a positive `offset`) or number of days before
...
<Accordion title="base" defaultOpen>
