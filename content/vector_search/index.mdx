...
<Accordion title="REMOTE_MODEL_NAME">

Name of the *model* hosted by the embedding service; e.g., `NV-Embed-QA`.

</Accordion>

<Accordion title="REMOTE_MODEL_LOCATION">
