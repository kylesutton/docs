...
<table class="table w-full [&_td]:min-w-[150px] [&_th]:text-left [&_td[data-numeric]]:tabular-nums">
  ...
  <tr>
    ...
    <td>For Nvidia models, the type of input on which embeddings will be generated: * <code>passage</code> - Input is the data set that will be searched. * <code>query</code>   - Input is the query that will be used for the search.</td>
  </tr>
  </tbody>
</table>
</div>
