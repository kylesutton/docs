...
<Accordion title="proc_name">

A system-wide unique name for the UDF

</Accordion>

<Accordion title="execution_mode">
...
<Accordion title="output_table_names">
