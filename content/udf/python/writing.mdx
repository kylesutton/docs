...
| `proc_data.request_info` | Map of strings to strings to strings to strings to strings | Returns a map of basic information about the [execute_proc()](../../../api/python/?source/gpudb.html#gpudb.GPUdb.execute_proc) request, map values being accessed using: <br/> <br/> `proc_data.request_info[<map_key>]` <br/> |
