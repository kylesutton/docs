---
title: UDF C++ Examples
---

<a id="udf-cpp-examples-label"></a>


The following are complete examples of the implementation & execution of
*User-Defined Functions (UDFs)* in the *UDF C++* API.

[Dist Cuda Sum Of Squares](/content/udf/cpp/examples/dist_cuda_sum_of_squares)
...
{/* Source: table_copy/udf_tc_cpp_proc.cpp */}
```c++
/* Sourced from:  gpudb-udf-api-cpp/proc-example/proc-example.cpp */
