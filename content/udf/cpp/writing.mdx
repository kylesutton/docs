...
| `procData->getRequestInfo()` | Map of strings to strings | Returns a map of basic information about the [/execute/proc](/content/api/rest/execute_proc_rest#execute-proc-rest) request, map values being accessed using: <br/> <br/> `procData->getRequestInfo().at(<map_key>)` <br/> <br/> The full set of map keys is listed below, under                     . |
