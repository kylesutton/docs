...
<p><strong>Connection to the Internet</strong></p>
...
<p><strong>Dependence on Kinetica via the API</strong></p>
...
* [Visual Initialization](#visual-initialization) - for installations where the *head node* has web
  browser access
* [Console Initialization](#console-initialization) - for installations without web browser access on
  the *head node*
