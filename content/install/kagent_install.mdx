...
2. Click **Install**. *KAgent* will open a window displaying the
   ...
   for that step. Click <img src="/content/install/img/kagent_details_copy_logs.png" alt="copy" style={{display: "inline", margin: 0, verticalAlign: "middle"}} /> to copy the displayed text.
   </Tip>
