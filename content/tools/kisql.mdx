...
<Accordion title="--url &lt;Kinetica URL&gt;" defaultOpen>
...
<Accordion title="--connectionString '&lt;JDBC URL&gt;'" defaultOpen>
...
<Accordion title="--primaryUrl &lt;Kinetica URL&gt;" defaultOpen>
...
<Accordion title="--user &lt;user ID&gt;" defaultOpen>
...
<Accordion title="--token &lt;OAuth token&gt;" defaultOpen>
...
<Accordion title="--tokenNameClaim &lt;claim&gt;" defaultOpen>

OAuth token claim key where the user name is located.  If not specified, the default is `sub`.

</Accordion>

<Accordion title="--trustStore &lt;filepath&gt;" defaultOpen>
...
<Accordion title="--bypassSslCertCheck [&lt;value&gt;]" defaultOpen>
...
<Accordion title="&lt; --s | --schema &gt; &lt;schema name&gt;" defaultOpen>
...
<Accordion title="--disableAutoDiscovery" defaultOpen>
...
<Accordion title="--disableFailover" defaultOpen>

[high availability](/content/ha) failover.

</Accordion>

<Accordion title="--disableSnappy" defaultOpen>
...
<Accordion title="&lt; -f | --file &gt; &lt;file path&gt;" defaultOpen>
...
<Accordion title="--debug [&lt;value&gt;]" defaultOpen>
...
<Accordion title="--delim '&lt;delimiter&gt;'" defaultOpen>
...
<Accordion title="--echoSql [&lt;value&gt;]" defaultOpen>
...
<Accordion title="--format &lt;format&gt;" defaultOpen>
...
<Accordion title="&lt; -i | --isql &gt;" defaultOpen>

Simulate <Badge color="blue-destructive">isql</Badge> output.

</Accordion>

<Accordion title="--limit &lt;record count&gt;" defaultOpen>
...
<Accordion title="--logLevel &lt;level&gt;" defaultOpen>
...
<Accordion title="--showTime [&lt;value&gt;]" defaultOpen>
...
<Accordion title="--stopOnFirstError" defaultOpen>

When using a SQL script as input (`--file` option), stop on the first error encountered.

</Accordion>

<Accordion title="&lt; -tz | --timeZone &gt; &lt;time zone ID&gt;" defaultOpen>
...
<Accordion title="--verbose [&lt;value&gt;]" defaultOpen>
...
<Accordion title="--listAllTimeZones" defaultOpen>

List all supported time zones and exit.

</Accordion>

<Accordion title="--version" defaultOpen>
...
<Accordion title="&lt; \c | \counts &gt; [&lt;schema&gt; [&lt;table&gt;]]" defaultOpen>
...
<Accordion title="&lt; \e | \edit &gt; [entry number]" defaultOpen>
...
<Accordion title="&lt; \f | \format &gt; &lt;type&gt;" defaultOpen>
...
<Accordion title="&lt; \h | \history &gt;" defaultOpen>
...
<Accordion title="&lt; \i | \indices &gt; [&lt;schema&gt; [&lt;table&gt;]]" defaultOpen>
...
<Accordion title="&lt; \k | \primaryKeys &gt; [&lt;schema&gt; [&lt;table&gt;]]" defaultOpen>
...
<Accordion title="&lt; \m | \metadata &gt;" defaultOpen>

Display connection metadata, including versions, supported features, & data types.

</Accordion>

<Accordion title="&lt; \p | \procedures &gt; [&lt;schema&gt; [&lt;procedure&gt;]]" defaultOpen>
...
<Accordion title="&lt; \r | \run &gt; [ID]" defaultOpen>
...
<Accordion title="&lt; \s | \schemas &gt;" defaultOpen>

Display the [schemas](/content/sql/ddl#sql-create-schema) to which the user has access.

</Accordion>

<Accordion title="&lt; \t | \tables &gt; [&lt;schema [&lt;table&gt;]]" defaultOpen>
...
<Accordion title="&lt; \u | \columns &gt; [&lt;schema&gt; [&lt;table&gt; [&lt;column&gt;]]]" defaultOpen>
...
<Accordion title="&lt; \v | \version &gt;" defaultOpen>
...
<Accordion title="&lt; \q | \quit | \exit &gt;" defaultOpen>
