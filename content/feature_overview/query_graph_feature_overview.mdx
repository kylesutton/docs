...
[Create Graph](/content/feature_overview/create_graph_feature_overview#create-graph-feature-overview) and returns a list
of adjacent edge(s) or node(s), also known as an adjacency list, depending on
...
and/or some [/match/graph examples](../../guide-tags/graph---query) before
using this endpoint.
