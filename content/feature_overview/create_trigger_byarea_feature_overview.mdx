...
[Create Trigger by Range](/content/feature_overview/create_trigger_byrange_feature_overview#create-trigger-byrange-feature-overview).)
Once the trigger has been activated, any record added to the listed tables(s)
via [Insert Records](/content/feature_overview/insert_records_feature_overview#insert-records-feature-overview) with the
...
[Show System Status](/content/feature_overview/show_system_status_feature_overview#show-system-status-feature-overview)) for
any listening client to collect. Active triggers can be cancelled by using the
[Clear Trigger](/content/feature_overview/clear_trigger_feature_overview#clear-trigger-feature-overview) endpoint or by
