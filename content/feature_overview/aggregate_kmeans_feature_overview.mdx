...
| info | map of string to strings | Additional information. <br/> <br/> The default value is an empty map ( \{\} ). <br/> <br/> qualified_result_table_name: The fully qualified name of the result table (i.e. including the schema) used to store the results. |
