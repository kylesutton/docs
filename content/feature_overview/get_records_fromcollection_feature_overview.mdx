...
| info | map of string to strings | Additional information.  The default value is an empty map ( \{\} ). <br/> <br/> total_number_of_records: Total number of records. <br/> has_more_records: Too many records. Returned a partial set. Possible values are: * true * false |
