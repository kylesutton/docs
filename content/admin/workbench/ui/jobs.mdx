...
* <img src="/content/admin/workbench/images/wb.explore_icon_refresh.png" alt="wb_icon_refresh" style={{display: "inline", margin: 0, verticalAlign: "middle"}} /> - refresh the displayed list of jobs
