...
3. Click <img src="/content/admin/workbench/images/wb.explore_wsb_icon_run.png" alt="wsb_icon_run" style={{display: "inline", margin: 0, verticalAlign: "middle"}} /> in that new *SQL Block* to run the generated query.
...
clicking <img src="/content/admin/workbench/images/wb.explore_wsb_icon_run.png" alt="wsb_icon_run" style={{display: "inline", margin: 0, verticalAlign: "middle"}} />:
