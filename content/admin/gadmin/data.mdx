...
* <img src="/content/admin/images/refresh.png" alt="refresh" style={{display: "inline", margin: 0, verticalAlign: "middle"}} /> (**Refresh**) -- refresh the list of *schemas*
...
* <img src="/content/admin/images/refresh.png" alt="refresh" style={{display: "inline", margin: 0, verticalAlign: "middle"}} /> (**Refresh**) -- refresh the list of *tables* & *views*
...
of your mouse to zoom in and out of an area. Click <img src="/content/admin/images/data_map_pencil.png" alt="pencil" style={{display: "inline", margin: 0, verticalAlign: "middle"}} /> to draw a polygon on
top of the map; this will act as a filter for the viewport. Click <img src="/content/admin/images/data_map_trash.png" alt="trash" style={{display: "inline", margin: 0, verticalAlign: "middle"}} /> to
...
* <img src="/content/admin/images/refresh.png" alt="refresh" style={{display: "inline", margin: 0, verticalAlign: "middle"}} /> (**Refresh**) -- refresh the table
   ...
   * To apply **Column Security**:
     ...
     4. Optionally, if the column is a `string` column, select a
        ...
        * **Mask** -- the column value will be masked after some length,
          ...
          exists for the column currently, one must be defined. Click <img src="/content/admin/images/data_col_mask_config.png" alt="gear" style={{display: "inline", margin: 0, verticalAlign: "middle"}} /> to
...
4. Click the <img src="/content/admin/images/data_col_mask_config.png" alt="gear" style={{display: "inline", margin: 0, verticalAlign: "middle"}} /> icon next to **Mask** to configure the masking
   values:
...
2. Select a desired *query* [configuration](/content/graph_solver/network_graph_solver#query-combinations) from the
   **Queries** drop-down menu and click **Add +**. For each
   ...
   <Tip>
   If you select `QUERY_NODE_WKTPOINT`, you can click <img src="/content/admin/images/wkt_select.png" alt="wkt_select" style={{display: "inline", margin: 0, verticalAlign: "middle"}} /> to
...
5. Select a node type from the **Source Nodes** drop-down menu and click
   **Add +**. For each field that appears after adding the node type,
   ...
   <Tip>
   If you select `NODE_WKTPOINT`, you can click <img src="/content/admin/images/wkt_select.png" alt="wkt_select" style={{display: "inline", margin: 0, verticalAlign: "middle"}} /> to open
...
9. Click **Solve Graph**. A WMS request of the solution(s) will open.
   Click a solution route to see the start (<img src="/content/admin/images/start_solution_route.png" alt="start" style={{display: "inline", margin: 0, verticalAlign: "middle"}} />) and end (<img src="/content/admin/images/finish_solution_route.png" alt="finish" style={{display: "inline", margin: 0, verticalAlign: "middle"}} />) points:
