...
<Accordion title="&lt; -h | --help &gt;" defaultOpen>
...
<Accordion title="--debug" defaultOpen>

Log debug messages.

</Accordion>

<Accordion title="--quiet" defaultOpen>

Suppress all output messages.

</Accordion>

<Accordion title="&lt; -f | --dbfile &gt; &lt;path&gt;" defaultOpen>

Path to KAgent cluster configuration database.

</Accordion>

<Accordion title="--kagent-dir &lt;path&gt;" defaultOpen>

Path to where KAgent and its playbooks reside.

</Accordion>

<Accordion title="&lt; -o | --output &gt; &lt;format&gt;" defaultOpen>
...
<Accordion title="--user &lt;username&gt;" defaultOpen>

Specify what user is performing the actions, for logging purposes.

</Accordion>

<Accordion title="&lt; -v | --verbose &gt;" defaultOpen>
...
<Accordion title="add [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="backup [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="control &lt;name&gt; &lt;operation&gt; &lt;component&gt;" defaultOpen>
...
<Accordion title="force-lock &lt;name&gt;" defaultOpen>

Force the ring with the given `name` to lock.

</Accordion>

<Accordion title="force-unlock &lt;name&gt;" defaultOpen>

Force the ring with the given `name` to unlock.

</Accordion>

<Accordion title="gather-logs [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="install &lt;name&gt;" defaultOpen>
...
<Accordion title="rabbit-recovery [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="remove &lt;name&gt;" defaultOpen>

Remove the ring with the given `name`.

</Accordion>

<Accordion title="update [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="upgrade [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="backup-configuration-files [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="backup-schedule &lt;name&gt;" defaultOpen>

List scheduled backups on the cluster with the given `name`.

</Accordion>

<Accordion title="bootstrap-kagent [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="check-for-upgrades &lt;name&gt;" defaultOpen>

Check if upgrades are available on-line for the cluster with the given `name`.

</Accordion>

<Accordion title="clone [options]" defaultOpen>
...
<Accordion title="get-conf-properties &lt;name&gt;" defaultOpen>

Show database configuration properties of the cluster with the given `name`.

</Accordion>

<Accordion title="get-logger [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="init [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="install [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="list-backup-contents [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="list-backups [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="list-cluster-contents &lt;name&gt;" defaultOpen>

List all of the tables on the cluster with the given `name`.

</Accordion>

<Accordion title="preflight &lt;name&gt;" defaultOpen>
...
<Accordion title="restore [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="secure [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="set-conf-properties [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="set-logger [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="uninstall &lt;name&gt;" defaultOpen>
...
<Accordion title="verify [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="write-inventory [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="discover-hostname [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="init [options] &lt;name&gt; &lt;addr&gt; &lt;cluster&gt;" defaultOpen>
...
<Accordion title="remove [options] &lt;name&gt;" defaultOpen>
...
<Accordion title="list [options]" defaultOpen>
...
<Accordion title="--retry-count &lt;number&gt;" defaultOpen>

Specify the `number` of connectivity check retries before failing over nodes.

</Accordion>

<Accordion title="--retry-delay &lt;seconds&gt;" defaultOpen>
...
<Accordion title="--clear-data &lt;yes|no&gt;" defaultOpen>
...
<Accordion title="--proceed &lt;yes|no&gt;" defaultOpen>
...
<Accordion title="--interval &lt;schedule&gt;" defaultOpen>
...
<Accordion title="--is-bootstrapped &lt;yes|no&gt;" defaultOpen>
...
<Accordion title="--force-bootstrap-unlock &lt;yes|no&gt;" defaultOpen>
