...
* Click the <img src="/content/admin/images/kagent_head_node_icon.png" alt="headnode" style={{display: "inline", margin: 0, verticalAlign: "middle"}} /> icon in the **Nodes** column to open a browser
