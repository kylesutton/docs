...
<Accordion title="JSON(expr)" defaultOpen>
...
<Accordion title="JSON_ARRAY (value[,...] &lt;null_hand&gt;)" defaultOpen>
...
<Accordion title="JSON_ARRAY_APPEND(arr, value)" defaultOpen>
...
<Accordion title="JSON_ARRAY_CONTAINS (json, path, val)" defaultOpen>
...
<Accordion title="JSON_CARDINALITY(json)" defaultOpen>

Alias for `JSON_LENGTH`

</Accordion>

<Accordion title="JSON_EXISTS(json, path)" defaultOpen>
...
<Accordion title="JSON_KEYS(json, path)" defaultOpen>
...
<Accordion title="JSON_LENGTH(json[, path])" defaultOpen>
...
<Accordion title="JSON_MAKE_ARRAY(value)" defaultOpen>
...
<Accordion title="JSON_OBJECT (value[,...] &lt;null_hand&gt;)" defaultOpen>
...
<Accordion title="JSON_PRETTY(json)" defaultOpen>
...
<Accordion title="JSON_QUERY (json, path [&lt;return&gt;])" defaultOpen>
...
<Accordion title="JSON_REPLACE(json, path, repl)" defaultOpen>
...
<Accordion title="JSON_TYPE(expr)" defaultOpen>
...
<Accordion title="JSON_VALUE (json, path [return])" defaultOpen>
...
<Accordion title="JSON_ARRAYAGG(expr)" defaultOpen>
...
<Accordion title="JSON_ARRAYAGG_DISTINCT(expr)" defaultOpen>
...
<Accordion title="&lt;column alias&gt;" defaultOpen>
...
<Accordion title="WITH ORDINALITY" defaultOpen>
...
<Accordion title="&lt;column alias list&gt;" defaultOpen>
...
<Accordion title="&lt;ordinality alias&gt;" defaultOpen>
...
<Accordion title="&lt;table alias&gt;" defaultOpen>
...
<Accordion title="&lt;table/columns aliases&gt;" defaultOpen>
