...
<Accordion title="JSON_ARRAY (value[,...] &lt;null_hand&gt;)">
...
<Accordion title="JSON_ARRAY_APPEND(arr, value)">
...
<Accordion title="JSON_ARRAY_CONTAINS (json, path, val)">
...
<Accordion title="JSON_CARDINALITY(json)">

Alias for `JSON_LENGTH`

</Accordion>

<Accordion title="JSON_EXISTS(json, path)">
...
<Accordion title="JSON_KEYS(json, path)">
...
<Accordion title="JSON_LENGTH(json[, path])">
...
<Accordion title="JSON_MAKE_ARRAY(value)">
...
<Accordion title="JSON_OBJECT (value[,...] &lt;null_hand&gt;)">
...
<Accordion title="JSON_PRETTY(json)">
...
<Accordion title="JSON_QUERY (json, path [&lt;return&gt;])">
...
<Accordion title="JSON_REPLACE(json, path, repl)">
...
<Accordion title="JSON_TYPE(expr)">
...
<Accordion title="JSON_VALUE (json, path [return])">
...
<Accordion title="JSON_ARRAYAGG(expr)">
...
<Accordion title="JSON_ARRAYAGG_DISTINCT(expr)">
