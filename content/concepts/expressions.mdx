...
<Accordion title="CASE(expr, {&lt;matches&gt;}, {&lt;values&gt;}, value_if_no_match)" defaultOpen>
...
<Accordion title="CAST (original value, destination type)" defaultOpen>
...
<Accordion title="CONVERT (original value, destination type, style)" defaultOpen>
...
<Accordion title="LAST_DAY(expr)" defaultOpen>
...
<Accordion title="NEXT_DAY(date, expr)" defaultOpen>
...
<Accordion title="TIMEBOUNDARYDIFF (unit, begin, end)" defaultOpen>
...
<Accordion title="ILIKE(expr, match[, esc_char])" defaultOpen>
...
<Accordion title="LIKE(expr, match[, esc_char])" defaultOpen>
...
<Accordion title="POSITION(match, expr[, start_pos])" defaultOpen>
...
<Accordion title="COUNT_DISTINCT(expr)" defaultOpen>
