...
<Accordion title="CASE(expr, {&lt;matches&gt;}, {&lt;values&gt;}, value_if_no_match)">
...
<Accordion title="CAST (original value, destination type)">
...
<Accordion title="CONVERT (original value, destination type, style)">
...
<Accordion title="NEXT_DAY(date, expr)">
...
<Accordion title="TIMEBOUNDARYDIFF (unit, begin, end)">
...
<Accordion title="ILIKE(expr, match[, esc_char])">
...
<Accordion title="LIKE(expr, match[, esc_char])">
...
<Accordion title="POSITION(match, expr[, start_pos])">
...
<Accordion title="COUNT_DISTINCT(expr)">
